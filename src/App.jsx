...
function MainApp() {
    return (
        <div className="full-page-container">
            <div className='content-container col d-flex flex-column align-items-center justify-content-center'>
                <div className="title mb-4">
                    <img src={reactLogo} alt="React Logo" />
                </div>
                 {/* Previous Drag & Drop code - kept for reference */}
                ...
                {/* New implementation - ScanButton for all screen sizes */}
